...
mat1 %*% mat2
```
The matrix multiplication example is straightforward example, and there is little benefit of using the einstein notation over the more familiar matrix product expression. Furthermore, 'einsum' is a lot slower. 
